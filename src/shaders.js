...
export const PRESETS = {
    ...
    'Aurora Ribbon': {
        noiseType:'wave',geometryType:'plane',
        uColorA:{r:0,g:10,b:18},uColorB:{r:0,g:90,b:120},uColorC:{r:90,g:255,b:190},uColorD:{r:210,g:255,b:245},
        uScale:2.2,uSpeed:0.35,uDisplacementStrength:0.18,uTwist:0.1,uPulse:1.2,uMorphFactor:0.0,
        uMetalness:0.2,uLightIntensity:1.0,uContrast:1.1,uSaturation:1.35,uGamma:1.1,
        uRimPower:4.5,uRimColor:{r:120,g:240,b:210},uFresnelStrength:5.0,uGlowRadius:0.7,
        bloomStrength:1.8,bloomRadius:0.6,bloomThreshold:0.2,
    },
    'Monochrome Ink': {
        noiseType:'ridged',geometryType:'sphere',
        uColorA:{r:10,g:10,b:10},uColorB:{r:35,g:35,b:35},uColorC:{r:170,g:170,b:170},uColorD:{r:245,g:245,b:245},
        uScale:4.5,uSpeed:0.12,uDisplacementStrength:0.12,uTwist:0.0,uPulse:0.7,uMorphFactor:0.0,
        uMetalness:0.05,uLightIntensity:1.6,uContrast:1.7,uSaturation:0.2,uGamma:1.05,
        uRimPower:7.0,uRimColor:{r:255,g:255,b:255},uFresnelStrength:9.0,uGlowRadius:0.2,
        bloomStrength:0.9,bloomRadius:0.3,bloomThreshold:0.45,
    },
    'Retro Sunset': {
        noiseType:'plasma',geometryType:'torus',
        uColorA:{r:40,g:0,b:30},uColorB:{r:190,g:40,b:80},uColorC:{r:255,g:120,b:40},uColorD:{r:255,g:220,b:150},
        uScale:2.8,uSpeed:0.45,uDisplacementStrength:0.28,uTwist:0.4,uPulse:2.0,uMorphFactor:0.1,
        uMetalness:0.15,uLightIntensity:1.4,uContrast:1.25,uSaturation:1.7,uGamma:0.95,
        uRimPower:3.2,uRimColor:{r:255,g:140,b:90},uFresnelStrength:4.2,uGlowRadius:0.8,
        cyberpunkMode:true,bloomStrength:2.2,bloomRadius:0.45,bloomThreshold:0.15,
    },
    'Industrial Rust': {
        noiseType:'voronoi',geometryType:'gear',
        uColorA:{r:12,g:8,b:5},uColorB:{r:85,g:45,b:25},uColorC:{r:180,g:95,b:45},uColorD:{r:210,g:170,b:120},
        uScale:3.2,uSpeed:0.22,uDisplacementStrength:0.45,uTwist:0.25,uPulse:1.4,uMorphFactor:0.1,
        uMetalness:0.85,uLightIntensity:1.7,uContrast:1.3,uSaturation:1.15,uGamma:1.05,
        uRimPower:2.4,uRimColor:{r:210,g:140,b:80},uFresnelStrength:3.2,uGlowRadius:0.45,
        bloomStrength:1.1,bloomRadius:0.35,bloomThreshold:0.28,
    },
    'Bio Hazard': {
        noiseType:'react',geometryType:'knot35',
        uColorA:{r:2,g:18,b:0},uColorB:{r:20,g:90,b:10},uColorC:{r:90,g:255,b:30},uColorD:{r:220,g:255,b:180},
        uScale:5.2,uSpeed:0.55,uDisplacementStrength:0.38,uTwist:1.4,uPulse:2.8,uMorphFactor:0.25,
        uMetalness:0.35,uLightIntensity:1.25,uContrast:1.45,uSaturation:1.6,uGamma:0.9,
        uRimPower:3.8,uRimColor:{r:150,g:255,b:90},uFresnelStrength:5.5,uGlowRadius:0.9,
        glitchMode:true,bloomStrength:2.6,bloomRadius:0.4,bloomThreshold:0.12,
    },
    'Velvet Dream': {
        noiseType:'marble',geometryType:'mobius',
        uColorA:{r:20,g:8,b:30},uColorB:{r:80,g:20,b:95},uColorC:{r:180,g:80,b:180},uColorD:{r:245,g:210,b:255},
        uScale:2.1,uSpeed:0.18,uDisplacementStrength:0.16,uTwist:0.6,uPulse:1.1,uMorphFactor:0.12,
        uMetalness:0.45,uLightIntensity:1.35,uContrast:1.05,uSaturation:1.3,uGamma:1.18,
        uRimPower:5.4,uRimColor:{r:220,g:170,b:255},uFresnelStrength:7.2,uGlowRadius:0.65,
        bloomStrength:1.9,bloomRadius:0.55,bloomThreshold:0.22,
    },
    'Solar Flare': { noiseType:'plasma',geometryType:'sphere',uColorA:{r:40,g:10,b:0},uColorB:{r:160,g:40,b:0},uColorC:{r:255,g:130,b:20},uColorD:{r:255,g:240,b:180},uScale:2.7,uSpeed:0.5,uDisplacementStrength:0.35,uTwist:0.3,uPulse:2.0,uMorphFactor:0.1,uMetalness:0.3,uLightIntensity:1.7,uContrast:1.3,uSaturation:1.5,uGamma:1.0,uRimPower:3.5,uRimColor:{r:255,g:170,b:90},uFresnelStrength:4.5,uGlowRadius:0.7,bloomStrength:2.0,bloomRadius:0.45,bloomThreshold:0.15 },
    'Moon Dust': { noiseType:'fbm',geometryType:'icosahedron',uColorA:{r:12,g:12,b:18},uColorB:{r:40,g:45,b:65},uColorC:{r:120,g:140,b:170},uColorD:{r:230,g:235,b:245},uScale:3.8,uSpeed:0.08,uDisplacementStrength:0.12,uTwist:0.0,uPulse:0.6,uMorphFactor:0.0,uMetalness:0.55,uLightIntensity:1.4,uContrast:1.2,uSaturation:0.7,uGamma:1.1,uRimPower:6.5,uRimColor:{r:210,g:220,b:240},uFresnelStrength:8.0,uGlowRadius:0.25,bloomStrength:0.8,bloomRadius:0.35,bloomThreshold:0.4 },
    'Toxic Grid': { noiseType:'truchet',geometryType:'plane',uColorA:{r:0,g:5,b:0},uColorB:{r:0,g:60,b:0},uColorC:{r:90,g:255,b:60},uColorD:{r:220,g:255,b:200},uScale:9.0,uSpeed:0.6,uDisplacementStrength:0.05,uTwist:0.0,uPulse:0.8,uMorphFactor:0.0,uMetalness:0.0,uLightIntensity:1.0,uContrast:1.9,uSaturation:1.4,uGamma:0.9,uRimPower:8.0,uRimColor:{r:90,g:255,b:90},uFresnelStrength:9.0,uGlowRadius:0.2,glitchMode:true,bloomStrength:2.3,bloomRadius:0.3,bloomThreshold:0.1 },
    'Obsidian': { noiseType:'ridged',geometryType:'dodecahedron',uColorA:{r:2,g:2,b:4},uColorB:{r:15,g:15,b:25},uColorC:{r:50,g:60,b:80},uColorD:{r:180,g:190,b:220},uScale:4.0,uSpeed:0.12,uDisplacementStrength:0.2,uTwist:0.4,uPulse:0.9,uMorphFactor:0.05,uMetalness:0.95,uLightIntensity:1.9,uContrast:1.4,uSaturation:0.8,uGamma:1.15,uRimPower:5.8,uRimColor:{r:200,g:220,b:255},uFresnelStrength:7.5,uGlowRadius:0.3,bloomStrength:1.0,bloomRadius:0.4,bloomThreshold:0.35 },
    'Bubble Gum': { noiseType:'cellular',geometryType:'torus',uColorA:{r:40,g:0,b:30},uColorB:{r:180,g:40,b:140},uColorC:{r:255,g:120,b:200},uColorD:{r:255,g:220,b:245},uScale:3.3,uSpeed:0.55,uDisplacementStrength:0.3,uTwist:0.7,uPulse:2.2,uMorphFactor:0.18,uMetalness:0.2,uLightIntensity:1.2,uContrast:1.15,uSaturation:1.8,uGamma:0.98,uRimPower:3.0,uRimColor:{r:255,g:180,b:220},uFresnelStrength:4.2,uGlowRadius:0.9,bloomStrength:2.1,bloomRadius:0.5,bloomThreshold:0.16 },
    'Rainforest': { noiseType:'warp',geometryType:'sphere',uColorA:{r:5,g:20,b:5},uColorB:{r:20,g:80,b:25},uColorC:{r:80,g:170,b:60},uColorD:{r:220,g:250,b:170},uScale:2.9,uSpeed:0.28,uDisplacementStrength:0.24,uTwist:0.2,uPulse:1.3,uMorphFactor:0.08,uMetalness:0.25,uLightIntensity:1.3,uContrast:1.1,uSaturation:1.4,uGamma:1.08,uRimPower:4.2,uRimColor:{r:160,g:230,b:130},uFresnelStrength:5.1,uGlowRadius:0.6,bloomStrength:1.3,bloomRadius:0.45,bloomThreshold:0.25 },
    'Purple Haze': { noiseType:'simplex',geometryType:'knot23',uColorA:{r:8,g:0,b:20},uColorB:{r:70,g:10,b:120},uColorC:{r:180,g:80,b:255},uColorD:{r:245,g:210,b:255},uScale:2.4,uSpeed:0.5,uDisplacementStrength:0.34,uTwist:1.1,uPulse:2.4,uMorphFactor:0.2,uMetalness:0.35,uLightIntensity:1.25,uContrast:1.2,uSaturation:1.7,uGamma:1.02,uRimPower:4.0,uRimColor:{r:200,g:140,b:255},uFresnelStrength:5.0,uGlowRadius:0.95,bloomStrength:2.0,bloomRadius:0.52,bloomThreshold:0.13 },
    'Frost Bite': { noiseType:'voronoi',geometryType:'octahedron',uColorA:{r:0,g:10,b:20},uColorB:{r:10,g:70,b:120},uColorC:{r:130,g:220,b:255},uColorD:{r:240,g:250,b:255},uScale:3.6,uSpeed:0.2,uDisplacementStrength:0.22,uTwist:0.3,uPulse:1.1,uMorphFactor:0.0,uMetalness:0.8,uLightIntensity:1.6,uContrast:1.05,uSaturation:0.95,uGamma:1.2,uRimPower:6.2,uRimColor:{r:190,g:240,b:255},uFresnelStrength:8.2,uGlowRadius:0.35,bloomStrength:1.1,bloomRadius:0.55,bloomThreshold:0.3 },
    'Coral Reef': { noiseType:'wave',geometryType:'spring',uColorA:{r:10,g:20,b:30},uColorB:{r:0,g:90,b:110},uColorC:{r:255,g:120,b:100},uColorD:{r:255,g:240,b:200},uScale:2.6,uSpeed:0.42,uDisplacementStrength:0.3,uTwist:0.9,uPulse:1.9,uMorphFactor:0.14,uMetalness:0.25,uLightIntensity:1.35,uContrast:1.15,uSaturation:1.5,uGamma:1.0,uRimPower:3.6,uRimColor:{r:255,g:170,b:130},uFresnelStrength:4.6,uGlowRadius:0.75,bloomStrength:1.8,bloomRadius:0.48,bloomThreshold:0.2 },
    'Neutron Star': { noiseType:'galaxy',geometryType:'sphere',uColorA:{r:0,g:0,b:5},uColorB:{r:20,g:10,b:80},uColorC:{r:120,g:150,b:255},uColorD:{r:255,g:255,b:255},uScale:1.8,uSpeed:0.22,uDisplacementStrength:0.15,uTwist:0.0,uPulse:0.9,uMorphFactor:0.0,uMetalness:0.6,uLightIntensity:1.0,uContrast:1.25,uSaturation:1.4,uGamma:1.2,uRimPower:7.0,uRimColor:{r:180,g:210,b:255},uFresnelStrength:9.0,uGlowRadius:1.1,bloomStrength:2.7,bloomRadius:0.7,bloomThreshold:0.06 },
    'Sandstorm': { noiseType:'fbm',geometryType:'plane',uColorA:{r:25,g:15,b:5},uColorB:{r:110,g:70,b:25},uColorC:{r:220,g:170,b:90},uColorD:{r:255,g:235,b:170},uScale:3.4,uSpeed:0.4,uDisplacementStrength:0.32,uTwist:0.2,uPulse:1.5,uMorphFactor:0.1,uMetalness:0.1,uLightIntensity:1.5,uContrast:1.3,uSaturation:1.2,uGamma:1.0,uRimPower:2.8,uRimColor:{r:230,g:190,b:120},uFresnelStrength:3.8,uGlowRadius:0.5,bloomStrength:1.2,bloomRadius:0.4,bloomThreshold:0.28 },
    'Electric Mint': { noiseType:'acid',geometryType:'torusknot',uColorA:{r:0,g:25,b:15},uColorB:{r:0,g:120,b:80},uColorC:{r:90,g:255,b:190},uColorD:{r:220,g:255,b:245},uScale:2.3,uSpeed:1.0,uDisplacementStrength:0.42,uTwist:1.8,uPulse:3.5,uMorphFactor:0.22,uMetalness:0.1,uLightIntensity:1.1,uContrast:1.35,uSaturation:1.9,uGamma:0.95,uRimPower:2.8,uRimColor:{r:120,g:255,b:210},uFresnelStrength:3.6,uGlowRadius:0.9,cyberpunkMode:true,bloomStrength:2.4,bloomRadius:0.5,bloomThreshold:0.11 },
    'Copper Wire': { noiseType:'hex',geometryType:'cylinder',uColorA:{r:15,g:8,b:5},uColorB:{r:80,g:40,b:20},uColorC:{r:190,g:100,b:50},uColorD:{r:245,g:200,b:140},uScale:4.8,uSpeed:0.25,uDisplacementStrength:0.2,uTwist:0.4,uPulse:1.2,uMorphFactor:0.05,uMetalness:0.9,uLightIntensity:1.8,uContrast:1.35,uSaturation:1.1,uGamma:1.08,uRimPower:3.0,uRimColor:{r:220,g:140,b:80},uFresnelStrength:4.1,uGlowRadius:0.35,bloomStrength:1.0,bloomRadius:0.32,bloomThreshold:0.33 },
    'Hyper Pop': { noiseType:'plasma',geometryType:'heart',uColorA:{r:20,g:0,b:20},uColorB:{r:255,g:40,b:130},uColorC:{r:255,g:220,b:0},uColorD:{r:0,g:240,b:255},uScale:3.0,uSpeed:0.9,uDisplacementStrength:0.4,uTwist:1.5,uPulse:3.0,uMorphFactor:0.25,uMetalness:0.0,uLightIntensity:1.25,uContrast:1.5,uSaturation:2.0,uGamma:0.92,uRimPower:2.6,uRimColor:{r:255,g:180,b:230},uFresnelStrength:3.4,uGlowRadius:1.1,cyberpunkMode:true,bloomStrength:2.8,bloomRadius:0.58,bloomThreshold:0.1 },
    'Misty Morning': { noiseType:'marble',geometryType:'sphere',uColorA:{r:25,g:28,b:35},uColorB:{r:90,g:105,b:125},uColorC:{r:170,g:190,b:205},uColorD:{r:245,g:250,b:255},uScale:2.1,uSpeed:0.09,uDisplacementStrength:0.1,uTwist:0.0,uPulse:0.6,uMorphFactor:0.0,uMetalness:0.4,uLightIntensity:1.1,uContrast:0.95,uSaturation:0.75,uGamma:1.2,uRimPower:5.5,uRimColor:{r:220,g:235,b:255},uFresnelStrength:7.0,uGlowRadius:0.25,bloomStrength:0.7,bloomRadius:0.45,bloomThreshold:0.45 },
    'Pulse Wireframe': { noiseType:'wave',geometryType:'torus',uColorA:{r:5,g:5,b:10},uColorB:{r:20,g:40,b:90},uColorC:{r:120,g:220,b:255},uColorD:{r:255,g:255,b:255},uScale:3.9,uSpeed:0.7,uDisplacementStrength:0.3,uTwist:0.8,uPulse:2.8,uMorphFactor:0.15,uMetalness:0.5,uLightIntensity:1.3,uContrast:1.3,uSaturation:1.4,uGamma:1.0,uRimPower:4.2,uRimColor:{r:180,g:230,b:255},uFresnelStrength:5.4,uGlowRadius:0.6,bloomStrength:1.7,bloomRadius:0.44,bloomThreshold:0.2,wireframe:true },
    'Night Traffic': { noiseType:'cellular',geometryType:'plane',uColorA:{r:2,g:2,b:8},uColorB:{r:20,g:20,b:35},uColorC:{r:255,g:90,b:0},uColorD:{r:255,g:255,b:180},uScale:6.0,uSpeed:0.75,uDisplacementStrength:0.08,uTwist:0.0,uPulse:1.0,uMorphFactor:0.0,uMetalness:0.0,uLightIntensity:1.0,uContrast:1.8,uSaturation:1.6,uGamma:0.95,uRimPower:6.0,uRimColor:{r:255,g:200,b:120},uFresnelStrength:7.0,uGlowRadius:0.3,bloomStrength:2.2,bloomRadius:0.35,bloomThreshold:0.12,glitchMode:true },
    'Ultraviolet': { noiseType:'react',geometryType:'capsule',uColorA:{r:4,g:0,b:20},uColorB:{r:50,g:0,b:120},uColorC:{r:150,g:0,b:255},uColorD:{r:240,g:180,b:255},uScale:4.2,uSpeed:0.48,uDisplacementStrength:0.36,uTwist:1.0,uPulse:2.1,uMorphFactor:0.2,uMetalness:0.4,uLightIntensity:1.4,uContrast:1.4,uSaturation:1.8,uGamma:1.03,uRimPower:4.7,uRimColor:{r:210,g:120,b:255},uFresnelStrength:6.0,uGlowRadius:0.85,bloomStrength:2.3,bloomRadius:0.5,bloomThreshold:0.14 },
    'Fog Machine': { noiseType:'simplex',geometryType:'plane',uColorA:{r:8,g:8,b:12},uColorB:{r:40,g:40,b:55},uColorC:{r:130,g:130,b:150},uColorD:{r:230,g:230,b:245},uScale:1.9,uSpeed:0.16,uDisplacementStrength:0.1,uTwist:0.0,uPulse:0.7,uMorphFactor:0.0,uMetalness:0.15,uLightIntensity:0.9,uContrast:0.9,uSaturation:0.6,uGamma:1.25,uRimPower:6.3,uRimColor:{r:220,g:220,b:235},uFresnelStrength:8.5,uGlowRadius:0.2,bloomStrength:0.6,bloomRadius:0.5,bloomThreshold:0.5 },
    'Prism Pop': { noiseType:'warp',geometryType:'klein',uColorA:{r:0,g:5,b:20},uColorB:{r:0,g:80,b:180},uColorC:{r:255,g:0,b:180},uColorD:{r:255,g:255,b:120},uScale:2.7,uSpeed:0.62,uDisplacementStrength:0.3,uTwist:1.2,uPulse:2.6,uMorphFactor:0.24,uMetalness:0.25,uLightIntensity:1.4,uContrast:1.45,uSaturation:1.9,uGamma:0.94,uRimPower:3.4,uRimColor:{r:180,g:220,b:255},uFresnelStrength:4.4,uGlowRadius:1.0,cyberpunkMode:true,bloomStrength:2.6,bloomRadius:0.57,bloomThreshold:0.1 },
    'Molten Metal': { noiseType:'ridged',geometryType:'gear',uColorA:{r:10,g:6,b:4},uColorB:{r:70,g:35,b:15},uColorC:{r:220,g:110,b:35},uColorD:{r:255,g:220,b:150},uScale:3.1,uSpeed:0.3,uDisplacementStrength:0.5,uTwist:0.4,uPulse:1.7,uMorphFactor:0.1,uMetalness:1.0,uLightIntensity:2.1,uContrast:1.5,uSaturation:1.2,uGamma:1.0,uRimPower:2.9,uRimColor:{r:255,g:170,b:90},uFresnelStrength:3.9,uGlowRadius:0.6,bloomStrength:1.8,bloomRadius:0.38,bloomThreshold:0.2 },
    'Forest Spirit': { noiseType:'curl',geometryType:'trefoil',uColorA:{r:0,g:18,b:8},uColorB:{r:15,g:70,b:35},uColorC:{r:110,g:210,b:120},uColorD:{r:230,g:255,b:220},uScale:2.4,uSpeed:0.26,uDisplacementStrength:0.26,uTwist:0.9,uPulse:1.6,uMorphFactor:0.12,uMetalness:0.2,uLightIntensity:1.3,uContrast:1.08,uSaturation:1.35,uGamma:1.1,uRimPower:4.8,uRimColor:{r:170,g:240,b:170},uFresnelStrength:6.1,uGlowRadius:0.55,bloomStrength:1.4,bloomRadius:0.46,bloomThreshold:0.24 },
};
